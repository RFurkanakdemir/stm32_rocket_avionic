...
Core/filter/Src/%.o Core/filter/Src/%.su: ../Core/filter/Src/%.c Core/filter/Src/subdir.mk
...
clean-Core-2f-filter-2f-Src:
	-$(RM) ./Core/filter/Src/FusionAHRS.d ./Core/filter/Src/FusionAHRS.o ./Core/filter/Src/FusionAHRS.su ./Core/filter/Src/LowPassFilter.d ./Core/filter/Src/LowPassFilter.o ./Core/filter/Src/LowPassFilter.su ./Core/filter/Src/NotchFilter.d ./Core/filter/Src/NotchFilter.o ./Core/filter/Src/NotchFilter.su ./Core/filter/Src/quaternion.d ./Core/filter/Src/quaternion.o ./Core/filter/Src/quaternion.su
